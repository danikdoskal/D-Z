...
but_rost=Button(root,text='Неограниченный рост', width=25, height=1, bg='orange');but_rost.place(x=80,y=40)
...
but_ogr=Button(root,text='Ограниченный рост', width=25, height=1, bg='red');but_ogr.place(x=80,y=100)
...
but_sotl=Button(root,text='Ограниченный рост с отловом', width=25, height=1, bg='yellow');but_sotl.place(x=80,y=160)
...
but_zhertva=Button(root,text='Жертва-хищник', width=20, height=1,bg='gold');but_zhertva.place(x=270,y=220)
...
but_sotl.bind('<Button-1>',ogr_w_otl)
...
but_zhertva.bind('<Button-1>',zher_xi)
